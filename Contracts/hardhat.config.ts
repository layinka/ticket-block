...
import {node_url, accounts, addForkConfiguration, getMnemonic} from './utils/network';
...
const liveDeploymentAccount = {
	mnemonic: getMnemonic()//  || "test test test test test test test test test test test junk",
...
const config: HardhatUserConfig = {
	...
	networks: addForkConfiguration({
		...
		fantom: {
			...
			accounts:	process.env.PRIVATE_KEY_FTM_1 !== undefined ? [process.env.PRIVATE_KEY_FTM_1, process.env.PRIVATE_KEY!] : [],
			chainId: 250,
		},
