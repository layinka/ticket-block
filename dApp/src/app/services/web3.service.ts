...
import { arbitrum, auroraTestnet, fantom, fantomTestnet, mainnet, polygon, sepolia } from '@wagmi/core/chains';
...
export class Web3Service {
  ...
  chains = [/*arbitrum, mainnet, polygon, sepolia, fantom, fantomTestnet,*/ auroraTestnet, aurora, hardhat];
  // 1. Define constants
